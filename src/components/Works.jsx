	...
	return (
		<motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
			<Tilt
				...
				className="dark:bg-tertiary bg-slate-900/40 p-5 rounded-2xl sm:w-[360px] w-full"
			>
		...
		<>
			...
			<div className="mt-10 block text-center">
				<a
					...
					target="_blank"
					className="inline-block dark:bg-tertiary bg-slate-900/40 py-3 px-8 outline-none w-fit text-white font-bold rounded-xl shadow-md shadow-primary"
				>
					View more
				</a>
			</div>
